...
function viewNutritionData() {
    ...
    jQuery(document).ajaxComplete( function() {
            ...
            info.append('<img src="images/remove.png" id="closegrid" onclick="closeGrid()">');
                                ...
                                for(j = 0; j < resultsinquery.length; j++) {
                                    ...
                                    if(recipeinquery == jsrecipes[i]) {
                                        ...
                                        if (j === (resultsinquery.length-1)) {
                                            var newcheckbox = 
                                            '<label class="col-xs-12" name="check"><input type="checkbox" name="recipe" value="' + jsrecipes[i] + '">' + jsrecipes[i] + '</input><img src="images/information.png" onclick="viewNutritionData()"/></label>';
