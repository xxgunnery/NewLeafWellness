        ...
        <div class="row aiListGenerator">
            <div class="aiCategories col-lg-8 col-xs-12">
                <div class="aiElement20">
                    ...
                    <div class="dropdown">
                        <div id="dropdownBox" class="dropdownText" onclick="openOptions()"><img src="images/downarrow.png" onclick="openOptions()">Protein type?</div>
        ...
        <div class="aiListContainer">
            <div class="row">
                ...
                <div class="col-xs-12 col-lg-8 col-lg-offset-2 buttons aiResultsButton">
                    <div onclick="viewResults()">View Shopping List</div>
                    <div onclick="viewResults()">View Selected Recipes</div>
