                        ...
                        for(j = 0; j < queryboxcontents.length; j++) {
                            ...
                            //then do something else if we've ensured no duplicates..
                                ...
                                if(j == (queryboxcontents.length - 1)) {
                                    ...
                                    addtoquerybox += '<div class="col-xs-12 queryBoxSelectionContainer"><div class="row"><div class="col-xs-1 queryBoxSelection"><img class="rightArrow" src="../wp-content/uploads/ai_images/rightarrow.png"/></div><div class="col-xs-10 queryBoxMeal"><p>' + selectedrecipe + '</p></div><div class="col-xs-1 queryBoxRemove"><img id="removeRecipe" src="../wp-content/uploads/ai_images/remove.png" onclick="removeSelection(event)"/></div></div></div>';
                                }
                            }
                        }
                    } else {
